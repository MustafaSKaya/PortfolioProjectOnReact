                ...
                <motion.div layout ref={ref} className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 techs mb-4">
                            <div className="row">
                                {skills.map((skill, index) => <motion.div key={skill.fields.label} initial={{ x: 300, opacity: 0 }} animate={inView ? { x: 0, opacity: 1 } : ''} transition={{ duration: index * .1 }} className='col-lg-4 col-md-4 col-sm-4 col-6 d-flex justify-content-start mt-3'>
